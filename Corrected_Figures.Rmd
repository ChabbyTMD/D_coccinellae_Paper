...
ggsave("Figure3.x.3.png", plot = plot, width = 14, height = 14, dpi = 300)
...
ggsave("Figure4.x.1.png", plot = fig_4, width = 14, height = 14, dpi = 300)
...
# hd_regression_plot <- hd_regression_plot + annotate("text", x = 0.689, y = 0.73, size = 5, label = reg_hd)
